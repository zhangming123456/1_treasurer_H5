(function ($) {
    ...
    Qrcode.prototype = {
        ...
        weiBoBridge: function () {
            window.WeiboJSBridge.invoke('scanQRCode', null, function (params) {
                //得到扫码的结果
                $('.result-qrcode').val(params.result);
            });
        },
        getImgFile: function () {
            var _this_ = this;
            ...
            oFReader.onload = function (oFREvent) {
                ...
                qrcode.callback = function (data) {
                    //得到扫码的结果
                    Qrcode.PromiseObj && Qrcode.PromiseObj(data);
                    $('.result-qrcode').focus().val(data).blur();
    ...
    Qrcode.init = function (tempBtn, cb) {
        var _this_ = this;

        tempBtn.each(function () {
            new _this_($(this));
        });
        Qrcode.PromiseObj = cb;
    };
