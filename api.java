  package com.zhenler.statement.v4.net;
    ...
    */
    ...
    public static final String BASE_FILE_NET_URL_NEW = "http://f.zhenler.com:8080";
    ...
    */
    ...
    // public static final String BASE_NET_URL_NEW = "http://192.168.134.116:8080";
    ...
    * 获取会员列表
    */
    public static final String GET_MEMBERRECHARGELOG_LIST_URL = SERVER_NAME +
    "/api/memberRechargeLog/getMemberRechargeLogList";
    ...
    * 查询用户信息
    */
    public static final String FIND_RES_USER = SERVER_NAME + "/api/resUser/findResUser";

    /**
    * 查询餐厅角色
    */
    public static final String FIND_ROLE_LIST = SERVER_NAME + "/api/role/findRoleList";

    /**
    * 绑定员工
    */
    public static final String BIND_RES_USER = SERVER_NAME + "/api/resUser/bindResUser";

    /**
    * 获取用户权限
    */
    public static final String GET_FUNCTIONS = SERVER_NAME + "/api/functions/getFunctions";

    /**
    * 获取短信剩余量
    */
    public static final String GET_MOBILE_MSG_COUNT = SERVER_NAME + "/api/mobileMsgCount/getMobileMsgCount";

    /**
    * 检查更新
    */
    public static final String GET_APP_INFO = SERVER_NAME + "/api/appInfo/getAppInfo";

    /**
    * 我的应用列表
    */
    public static final String GET_RES_MODULAR_LIST = SERVER_NAME + "/api/resmodular/getResModularList";

    /**
    * 短信发送记录
    */
    public static final String GET_MOBILE_MSG_LIST = SERVER_NAME + "/api/mobileMsg/getMobileMsgList";

    /**
    * 保存编辑餐厅员工
    */
    public static final String UPDATE_OR_SAVE_RES_USER = SERVER_NAME + "/api/resUser/updateOrSaveResUser";

    /**
    * 删除餐厅员工
    */
    public static final String DELETE_RES_USER = SERVER_NAME + "/api/resUser/deleteResUser";
    }
